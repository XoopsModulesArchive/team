...
$xoopsTpl->assign('lang_teamrosterfor', _MD_TEAMROSTERFOR);
...
$xoopsTpl->assign('lang_teamnationality', _MD_TEAMNATIONALITY);
$xoopsTpl->assign('lang_teamrank', _MD_TEAMRANK);
$xoopsTpl->assign('lang_teamposition', _MD_TEAMPOSITION);
$xoopsTpl->assign('lang_teammembersince', _MD_TEAMMEMBERSINCE);
